...
const simih = async (text) => {
	try {
		const sami = await fetch(`https://simsumi.herokuapp.com/api?text=${text.slice(2)}&lang=id`, {method: 'GET'})
...
const banner = cfonts.render(('PANJI|DEPARI'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","blue"],
...
module.exports = { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close, emojiStrip  }
